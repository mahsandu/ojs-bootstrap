<?php
/* Smarty version 4.3.1, created on 2023-06-21 07:03:20
  from 'app:controllersgridpluginsformuploadPluginForm.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.1',
  'unifunc' => 'content_64924c585a4a36_79329368',
...
function content_64924c585a4a36_79329368 (Smarty_Internal_Template $_smarty_tpl) {
echo '<script'; ?>
>
	$(function() {
		...
		$('#uploadPluginForm').pkpHandler(
			'$.pkp.controllers.form.FileUploadFormHandler',
			{
				$uploader: $('#plupload'),
				uploaderOptions: {
					uploadUrl: <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'json_encode' ][ 0 ], array( call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0], array( array('router'=>\PKP\core\PKPApplication::ROUTE_COMPONENT,'op'=>"uploadPluginFile",'function'=>$_smarty_tpl->tpl_vars['function']->value,'escape'=>false),$_smarty_tpl ) ) ));?>
,
...
<form class="pkp_form" id="uploadPluginForm" action="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0], array( array('router'=>\PKP\core\PKPApplication::ROUTE_COMPONENT,'op'=>"saveUploadPlugin",'function'=>$_smarty_tpl->tpl_vars['function']->value,'category'=>$_smarty_tpl->tpl_vars['category']->value,'plugin'=>$_smarty_tpl->tpl_vars['plugin']->value),$_smarty_tpl ) );?>
" method="post">
